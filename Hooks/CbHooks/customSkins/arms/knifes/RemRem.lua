...
game:GetObjects('rbxassetid://6906081071')[1].Parent = Model59548
...
game:GetObjects('rbxassetid://6906081071')[1].Parent = Model55609
Model = game.ReplicatedStorage.Viewmodels.Model
for _, Child in pairs(Model:GetChildren()) do
    Child.Parent = Model.Parent
end
Model:Destroy()
wait()
game.ReplicatedStorage.Viewmodels["v_whats nine plus ten"].Name = "v_CT Knife"
game.ReplicatedStorage.Viewmodels["v_whats nine plus ten"].Name = "v_T Knife"